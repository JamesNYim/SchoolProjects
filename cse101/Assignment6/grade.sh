...
echo ""
printf "%30s:  %5s  %5.1f%% of 50%% %s\n" "Tests" $passes"/"$tests $total "} Making it work"
printf "%30s:  %5s  %5.1f%% of 40%% %s\n" "Line and Function Coverage" $cstr $ccov "]"
printf "%30s:  %5s  %5.1f%% of  5%% %s\n" "Compiler Warnings" $ccstr $ccode "] Making it right"
